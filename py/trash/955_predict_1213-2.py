...
# -*- coding: utf-8 -*-
"""
Created on Thu Dec 13 05:32:21 2018
...
SUBMIT_FILE_PATH = '../output/1213-2.csv.gz'

COMMENT = 'top300 features * 5'
...
# load
# =============================================================================
COL = pd.read_csv('LOG/imp_816_cv_mlogloss.py-2.csv').head(USE_FEATURES ).feature.tolist()

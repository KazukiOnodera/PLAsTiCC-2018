...
SUBMIT_FILE_PATH = '../output/1214-3.csv.gz'
...
# load
# =============================================================================
imp = pd.read_csv('LOG/imp_used_1214-1.csv')

for x in REMOVE_PREFS:
    imp = imp[~imp.feature.str.contains(x)]

COL = imp.head( USE_FEATURES + (MOD_FEATURES*MOD_N) ).feature.tolist()

...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec  2 18:26:45 2018
...
SUBMIT_FILE_PATH = '../output/1202-1.csv.gz'

COMMENT = '1128-2 + LCfit'
...
# load
# =============================================================================
COL = pd.read_csv('LOG/imp_used_1128-2.csv').head(BASE_FEATURES).feature.tolist()
...
# f701
# =============================================================================
tr_f701 = pd.read_pickle('../data/train_f701.pkl')
te_f701 = pd.read_pickle('../data/test_f701.pkl.gz')


X = pd.concat([X, tr_f701], axis=1)

COL_tr = X.columns.tolist()
...
X_test = pd.concat([X_test, te_f701], axis=1)[COL_tr]

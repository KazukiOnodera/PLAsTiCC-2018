...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 16 01:04:08 2018
...
if __name__ == "__main__":
    ...
    df = pd.read_pickle('../FROM_MYTEAM/LCfit_feature_allSN_i_train_v2_20181213.pkl.gz')
    ...
    df = pd.read_pickle('../FROM_MYTEAM/LCfit_feature_allSN_i_test_v2_20181213.pkl.gz')

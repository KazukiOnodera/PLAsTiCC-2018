...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 16 00:51:23 2018
...
if __name__ == "__main__":
    ...
    df = pd.read_pickle('../FROM_MYTEAM/LCfit_feature_allSN_r_train_v2_20181215.pkl.gz')
    ...
    df = pd.read_pickle('../FROM_MYTEAM/LCfit_feature_allSN_r_test_v2_20181215.pkl.gz')

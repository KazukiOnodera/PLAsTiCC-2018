...
if __name__ == "__main__":
    ...
    df = pd.read_pickle('../FROM_MYTEAM/LCfit_feature_allSN_z_train_v2_20181214.pkl.gz')
    ...
    df = pd.read_pickle('../FROM_MYTEAM/LCfit_feature_allSN_z_test_v2_20181214.pkl.gz')

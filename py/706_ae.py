...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 16 01:08:41 2018
...
def aggregate(df, output_path, drop_oid=True):
    """
    df = pd.read_pickle('../FROM_MYTEAM/ae_train_v1.pkl.gz')
    """
...
if __name__ == "__main__":
    ...
    usecols = None
    aggregate(pd.read_pickle('../FROM_MYTEAM/ae_train_v1.pkl.gz'), f'../data/train_{PREF}.pkl')

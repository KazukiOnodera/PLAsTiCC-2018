...
# -*- coding: utf-8 -*-
"""
Created on Mon Dec 17 12:23:31 2018
...
if __name__ == "__main__":
    ...
    df = pd.read_pickle('../FROM_MYTEAM/switch_feature_train_20181202.pkl.gz')
...
#    get_feature(df)
    ...
    df = pd.read_pickle('../FROM_MYTEAM/switch_feature_test_20181202.pkl.gz')

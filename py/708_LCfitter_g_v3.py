...
# -*- coding: utf-8 -*-
"""
Created on Sun Dec 16 06:02:21 2018
...
if __name__ == "__main__":
    ...
    df = pd.read_pickle('../FROM_MYTEAM/LCfit_feature_allSN_g_train_v3_20181215.pkl.gz')
    ...
    df = pd.read_pickle('../FROM_MYTEAM/LCfit_feature_allSN_g_test_v3_20181215.pkl.gz')
